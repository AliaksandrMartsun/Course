...
class MyTemplateView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        return {"latest_question_list": [{'id': 1,
                            ...
                            {'id': 3,
                             'question_text': 'Существует ли свобода слова'},
                            {'id': 4,
...
def post_page(request, number):
    if number == 1:
        return HttpRespons(
            "Кто-то или что-то на славу потрудилась,"
            "придумав нас настолько непохожили друг на друга,"
        ...
        return HttpRespons(
            "Обычно проблематизируется в форме вопросаЖ"
        ...
        return HttpRespons(
            ...
            "существа). В современной филасофии подобные идеи можно"
        ...
        return HttpRespons("Другой вопрос")
